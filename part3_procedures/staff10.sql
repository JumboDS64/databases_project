drop procedure Staf_GetTopAgen_Tix;
delimiter //
create procedure Staf_GetTopAgen_Tix(token varchar(30), username varchar(60))
begin
    ...
    IF (vusername IS NOT NULL) THEN
		SELECT airline_staff.airline_name
            ...
            INTO myAirline;
		SELECT ticket.booking_agent_ID, COUNT(*) as sum_tickets -- let's assume agents earn 20% commision for every ticket they purchase
		FROM ticket
		LEFT JOIN flight
